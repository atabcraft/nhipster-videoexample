...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8080';
    'jhipster.clientApp.name' = 'videoexample';
    ...
    'jhipster.mail.from' = 'videoexample@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'videoexample API';
    'jhipster.swagger.description' = 'videoexample API documentation';
    ...
    'eureka.instance.appname' = 'videoexample';
    'eureka.instance.instanceId' = 'videoexample:${random.value}';
    ...
    'cloud.config.name' = 'videoexample';
